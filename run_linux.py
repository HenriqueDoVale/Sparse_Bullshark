...
async def run_node(node_id, tx_size, n_tx, mode, input_rate, rbc, no_prbc_sigs, timeout_ms, mempool, private_key,
    ...
    tasks = [
        asyncio.create_task(
            run_node(
                ...
                args.input_rate, args.rbc, args.no_prbc_sigs, args.timeout, args.mempool, priv_keys[n["id"]],
